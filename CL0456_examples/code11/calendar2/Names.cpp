...
TCHAR *nameOfBranches[EARTHLY_BRANCHES] = { _T("子"),_T("醜"),_T("寅"),_T("卯"),_T("辰"),_T("巳"),_T("午"),_T("未"),_T("申"),_T("酉"),_T("戌"),_T("亥") };
TCHAR *nameOfShengXiao[CHINESE_SHENGXIAO] = { _T("鼠"),_T("牛"),_T("虎"),_T("兔"),_T("龍"),_T("蛇"),_T("馬"),_T("羊"),_T("猴"),_T("雞"),_T("狗"),_T("豬") };
...
TCHAR *nameOfChnMonth[MONTHES_FOR_YEAR] = { _T("正"),_T("二"),_T("三"),_T("四"),_T("五"),_T("六"),_T("七"),_T("八"),_T("九"),_T("十"),_T("十一"),_T("臘") };
TCHAR *nameOfJieQi[SOLAR_TERMS_COUNT] = { _T("春分"), _T("清明"), _T("穀雨"), _T("立夏"), _T("小滿"), _T("芒種"), _T("夏至"), _T("小暑"), 
                                        _T("大暑"), _T("立秋"), _T("處暑"), _T("白露"), _T("秋分"), _T("寒露"), _T("霜降"), _T("立冬"), 
                                        _T("小雪"), _T("大雪"), _T("冬至"), _T("小寒"), _T("大寒"), _T("立春"), _T("雨水"), _T("驚蟄") };
