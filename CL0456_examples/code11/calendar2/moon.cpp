...
/*計算金星攝動,木星攝動以及地球扁率攝動對月球地心黃經的影響,dt 是儒略世紀數，Lp和F單位是度*/
...
/*計算金星攝動,木星攝動以及地球扁率攝動對月球地心黃緯的影響,dt 是儒略世紀數，Lp、Mp和F單位是度*/
...
double GetMoonEclipticLongitudeEC(double dbJD)
{
    ...
    double dt = (dbJD - JD2000) / 36525.0; /*儒略世紀數*/
    ...
    longitude = Mod360Degree(longitude); /*映射到0-360範圍內*/
    return longitude;
}
